...
{
    [Serializable]
    public class FMOD_OcclusionRayData
    {
        [Range(0f, 10f)]
        ...
        public float OccludeBetween(Vector3 sound, Vector3 listener) => OccludeBetween(sound, listener, this);
        public static float OccludeBetween(Vector3 sound, Vector3 listener, FMOD_OcclusionRayData occlusionRayData)
            => OccludeBetween(sound, listener, occlusionRayData.SoundOcclusionWidening, occlusionRayData.PlayerOcclusionWidening, occlusionRayData.OcclusionLayer);
